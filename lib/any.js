...
internals.Any.prototype.concat = function (schema) {
    ...
    obj._localSettings = obj._localSettings ? internals.concatSettings(obj._localSettings, schema._localSettings) : schema._localSettings;
...
internals.Any.prototype.describe = function () {
    ...
    const label = Hoek.reach(this._localSettings, 'label');
    if (label) {
